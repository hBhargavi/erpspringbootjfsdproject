...
<head>
   ...
   <style>
        ...
        table 
        {
            width: 10%; /* Increased width for better display */
            margin: 1px auto; /* Centering the table */
...
<body>
    ...
    <div class="container">
        <h3 class="text-center mt-5" align="center">Leave Application Status</h3>
    ...
    <div class="alert" style="color: red; background-color: transparent; font-weight: bold; text-align: center;">
