...
.success 
        ...
        .message-container .failed-symbol {
            color: red;
            font-size: 18px;
            margin-right: 5px;
        }
...
<br/><br/><br/><br/>
    ...
    <div class="form-container">
       ...
       <form action="updatepasswordotp" method="post">
    <input type="hidden" name="id" value="${id}">
    <input type="hidden" name="email" value="${email}">

    <div class="form-group">
        <label for="newpassword">New Password</label>
        <input  type="password" id="newpassword" name="newpassword" placeholder="Enter new password" required pattern=".{8,}" title="Password must be at least 8 characters long.">
    </div>
